 ...
 * @returns {*}
 */
const calibrate = module.exports = function (data, meta, options) {
 ...
 */
const response = module.exports.response = function (data, _meta, _options) {
 ...
 */
const decorate = module.exports.decorate = function (server, options, next) {
